...
*** Test Cases ***
Create Session And Verify Connection
    [Documentation]    Create Session And Verify Connection through Redfish.
...
Verify Created Session Resource
    [Documentation]    Verify Created Session Resource through Redfish.
...
Delete Created Session For Cleanup
    [Documentation]    Delete Created Session For Cleanup through Redfish.
